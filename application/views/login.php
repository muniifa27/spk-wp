...
<html lang="en">
    <head>
        ...
        <title>SMP IT INSAN MUBARAK</title>
    ...
    <body class="bg-gradient-primary">
        <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-primary" style="font-weight: 900;" href="<?= base_url('')?>"> <i class="fa"></i> SMP IT INSAN MUBARAK</a>
            </div>
        </nav>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                    <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                        <div class="text-justify card-body p-0">
                            <h4 style="font-weight: 800;">SPK WP - SMP IT INSAN MUBARAK</h4>
                            <div class="tengah"> 
                                <img style="border-radius: 3%;"src="<?= base_url('assets/img/logo.png'); ?>"/>
                            </div>
                            <p class="pt-4">
                                Selamat datang,
                            </p>
                            <p>
                                Sistem Penunjang Keputusan Untuk Menentukan Guru Terbaik di SMP IT INSAN MUBARAK
                            </p>
                        </div>
                    </div>
                </div>
